                ...
                <div className="space-y-4">
                  <Accordion type="single" collapsible className="w-full" defaultValue="what-to-expect">
                        ...
                        <AccordionItem value="package-options">
                            ...
                            <AccordionContent 
                                className="text-sm text-muted-foreground space-y-4">
                                <p>We can take a maximum of 6 people per walk. We have 3 alpacas, so if your group has more than 3 people, some will need to share an alpaca. Please select the "Shared Alpaca" ticket in this case.</p><p>The minimum age for a solo walk is 10. Younger children must be accompanied by a supervising adult.</p>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
